...
public class entrada_de_dados {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Voçê digitou %s%n", nome);//formatado texto//
	     System.out.printf("Voçê digitou %d%n", idade);//formatado numero//
	     System.out.printf("Voçê digitou %.2f%n", salario);//formatado numero com duas casas//
	     System.out.printf("Voçê digitou %s%n", sexo);//formatado numero com duas casas//
	     System.out.println("voçê digitou: " + nome);//concactenado texto//
	     System.out.println("voçê digitou: " + idade);//concactenado numero//
	     System.out.println("voçê digitou: " + salario);//concactenado numero com duas casas//
	     System.out.println("voçê digitou: " + sexo);//concactenado char true ou false//
		...
		sc.close();//saida do scanner indicando que não precisa mais da entrada de dados//
