...
public class Exercicio_estrutura_condiconal_5 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Digite o número do produto que deseja : %n" + " 1 cachorro quente R$4 %n" + " 2 x-salada R$4,50 %n" + " 3 X - bacon R$5 %n" + " 4 Torrada Simples R$2 %n" + " 5 Refrigerante R$1,50 %n");
		int cod = sc.nextInt();
